...
const contentStyle = computed<CSSProperties>(() => {
  ...
  if(layoutSetting.value.footer && layoutSetting.value.multiTab){
    defaultStyle.minHeight = `calc(100vh - ${layoutSetting.value.headerHeight}px - 62px - 40px)`
    ...
    defaultStyle.minHeight = `calc(100vh - ${layoutSetting.value.headerHeight}px  - 40px)`
  }else if(!layoutSetting.value.footer && !layoutSetting.value.multiTab){
