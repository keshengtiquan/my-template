...
<template>
  <a-popover v-model:open="open" placement="bottomRight" trigger="click">
    <template #content>
      ...
      <div class="popover">
        <!--   固定在左侧   -->
        <div v-if="fixedLeftColumns.length > 0" class="w-full pl-24px mx-6px font-size-12px text-[var(--text-color-1)]">
          固定在左侧</div>
        <VueDraggable v-model="fixedLeftColumns" :animation="150" @end="onDragChange" class="w-200px">
        ...
        <!--   不固定   -->
        <div v-if="fixedLeftColumns.length > 0 || fixedRightColumns.length > 0"
          class="w-full pl-24px mx-6px font-size-12px text-[var(--text-color-1)]">不固定</div>
        <VueDraggable v-model="notFixedColumns" :animation="150" @end="onDragChange" class="w-200px">
        ...
        <!--   固定在右侧   -->
        <div v-if="fixedRightColumns.length > 0"
          class="w-full pl-24px mx-6px font-size-12px text-[var(--text-color-1)]">固定在右侧
        </div>
        <VueDraggable v-model="fixedRightColumns" :animation="150" @end="onDragChange" class="w-200px">
